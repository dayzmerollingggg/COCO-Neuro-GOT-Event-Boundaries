...
#OUTPUT_DIR
GLM_DIR = os.path.join(DATA_DIR, 'glm/compare_contrasts_full')
AVERAGED_DATA_DIR = os.path.join(DATA_DIR, 'averaged_data/compare_contrasts_full')
FIG_DIR = os.path.join(DATA_DIR, 'figures/compare_contrasts_full')
...
def load_regressor_data(base_name, shift_type, regressor_type='convolved'):
    ...
    if regressor_type == 'convolved':
        bool_name = f'{dir_name}_bool_convolved.npy'
        amp_name = f'{dir_name}_amp_convolved.npy'
        ...
        for amp_type in AMPLITUDE_TYPES:
            for regressor_type in REGRESSOR_TYPES:
                ...
                if regressor_cam is None: continue # Skip this run if data is missing
                    ...
                    print(f"Successfully loaded camera regressor ({amp_type}) with shape: {regressor_cam.shape}")
                ...
                if regressor_scene is None: continue
                    ...
                    print(f"Successfully loaded scene regressor ({amp_type}) with shape: {regressor_scene.shape}")
                ...
                if regressor_medium is None: continue
                    ...
                    print(f"Successfully loaded medium regressor ({amp_type}) with shape: {regressor_medium.shape}")

...
def define_timestamp_data(timestamps_txt,file_name,duration_len):
    ...
    count_values_mean = count_values - np.mean(count_values)
    regressoramp(count_values_mean,file_name,duration_len)
    ...
    df = pd.DataFrame(data_cam)
    
    # Define the output file name
    output = f"{file_name}_boolean_data.csv"
